...
# 2.1.1. Traslación.
1. TraslaciónLa traslación consiste en mover un objeto de una posición a otra en el plano, sumando distancias a las coordenadas originales a lo largo de los ejes $X$ e $Y$.
Factores: $T_x$ (desplazamiento en $X$) y $T_y$ (desplazamiento en $Y$).
# 2.1.2. Escalamiento.
